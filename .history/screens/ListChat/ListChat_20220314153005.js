    ...
    const [Data, setData] = useState([
        {
            Id: 1,
            Name: 'File Truyền',
            Avatar: require('../../../assets/images/ListChat/ListChat/avatar/LogoSchat.png'),
            Messenger: 'Hello',
            UnreadMessage: 0,
            silent: true,
        },
        {
            Id: 2,
            Name: 'Ha My',
            Avatar: require('../../../assets/images/ListChat/ListChat/avatar/HaMy.png'),
            Messenger: 'Xin chào',
            UnreadMessage: 1,
            silent: false,
        },
        {
            Id: 3,
            Name: 'Ken Nguyen',
            Avatar: require('../../../assets/images/ListChat/ListChat/avatar/KenNguyen.png'),
        ...
        },
        {
            Id: 4,
            Name: 'Khaly',
            Avatar: require('../../../assets/images/ListChat/ListChat/avatar/Khaly.png'),
            Messenger: 'Bye Bye',
            UnreadMessage: 10,
            silent: true,
        },
        {
            Id: 5,
            Name: 'Mary',
            Avatar: require('../../../assets/images/ListChat/ListChat/avatar/Mary.png'),
            Messenger: 'Hihi',
            UnreadMessage: 1,
            silent: true,
        },
    ...
    const renderHeader = () => {
        return (
            <View style={index.Header}>
                <ImageBackground
                    source={require('../../../assets/images/ListChat/ListChat/MaskGroup.png')}
                    style={index.ImageBackground}
                >
                    <View style={index.BoxTop}>
                        <View style={index.BoxAvatar}>
                            <Image
                                source={require('../../../assets/images/ListChat/ListChat/avatar.png')}
                                style={index.avatar}
                            />
                        </View>
                        ...
                        <View style={index.BoxAdd}>
                            <Image
                                source={require('../../../assets/images/ListChat/ListChat/IconNews.png')}
                                style={index.IconNews}
                            />
                            <View>
                                <Image
                                    source={require('../../../assets/images/ListChat/ListChat/IconNotification.png')}
        ...
        return (
            <View style={index.Content}>
                    ...
                    <View style={index.PhoneBook}>
                        <View>
                            <View style={index.BoxPhoneBook}>
                                <Image
                                    source={require('../../../assets/images/ListChat/ListChat/Phonebook.png')}
                ...
                <View style={index.MenuBody}>
                    ...
                    <Image
                        source={require('../../../assets/images/ListChat/ListChat/list.png')}
