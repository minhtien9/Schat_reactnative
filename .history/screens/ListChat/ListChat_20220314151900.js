...
export default function ListChat() {
    ...
    const [Data, setData] = useState([
        {
            Id: 1,
            Name: 'File Truyền',
            Avatar: require('../.../../assets/images/ChatSingle/ChatSingle/avatar/LogoSchat.png'),
            Messenger: 'Hello',
            UnreadMessage: 0,
            silent: true,
        },
        {
            Id: 2,
            Name: 'Ha My',
            Avatar: require('../.../../assets/images/ChatSingle/ChatSingle/avatar/HaMy.png'),
            Messenger: 'Xin chào',
            UnreadMessage: 1,
            silent: false,
        },
        {
            Id: 3,
            Name: 'Ken Nguyen',
            Avatar: require('../.../../assets/images/ChatSingle/ChatSingle/avatar/KenNguyen.png'),
        ...
        },
        {
            Id: 4,
            Name: 'Khaly',
            Avatar: require('../../assets/images/ChatSingle/avatar/Khaly.png'),
            Messenger: 'Bye Bye',
            UnreadMessage: 10,
            silent: true,
        },
        {
            Id: 5,
            Name: 'Mary',
            Avatar: require('../../assets/images/ChatSingle/avatar/Mary.png'),
            Messenger: 'Hihi',
            UnreadMessage: 1,
            silent: true,
        },
        {
            Id: 6,
            Name: 'Schat',
            Avatar: require('../../assets/images/ChatSingle/avatar/LogoSchat.png'),
            Messenger: 'Hola',
            UnreadMessage: 2,
            silent: true,
        },
        {
            Id: 7,
            Name: 'Ha Vy',
            Avatar: require('../../assets/images/ChatSingle/avatar/HaMy.png'),
            Messenger: 'Xin chào',
            UnreadMessage: 1,
            silent: false,
        },
        {
            Id: 8,
            Name: 'Nguyen Ly',
            Avatar: require('../../assets/images/ChatSingle/avatar/KenNguyen.png'),
            Messenger: 'Có khỏe không bạn',
            UnreadMessage: 0,
            silent: false,
        },
                ...
                >
                    <View style={index.BoxTop}>
                        <View style={index.BoxAvatar}>
                            <Image
                                source={require('../../assets/images/ChatSingle/avatar.png')}
                                style={index.avatar}
                            />
                        </View>
                        ...
                        <View style={index.BoxAdd}>
                            <Image
                                source={require('../../assets/images/ChatSingle/IconNews.png')}
                                style={index.IconNews}
                            />
                            <View>
                                <Image
                                    source={require('../../assets/images/ChatSingle/IconNotification.png')}
        ...
        return (
            <View style={index.Content}>
                    ...
                    <View style={index.PhoneBook}>
                        <View>
                            <View style={index.BoxPhoneBook}>
                                <Image
                                    source={require('../../assets/images/ChatSingle/Phonebook.png')}
                ...
                <View style={index.MenuBody}>
                    ...
                    <Image
                        source={require('../../assets/images/ChatSingle/list.png')}
            ...
            <View style={index.FooterFriend}>
                ...
                <View style={index.FooterIcon}>
                    <View style={index.FooterIconLeft}>
                        <Image
                            source={require('../../assets/images/ChatSingle/Icon.png')}
                            style={index.icon}
                        />
                        <TouchableOpacity onPress={chooseFile}>
                            <Image
                                source={require('../../assets/images/ChatSingle/Upfile.png')}
                                style={index.icon}
                            />
                        </TouchableOpacity>
                        <Image
                            source={require('../../assets/images/ChatSingle/IconImage.png')}
                            style={index.icon}
                        />
                    </View>
                    <View style={index.FooterIconRight}>
                        <Image
                            source={require('../../assets/images/ChatSingle/IconExtend.png')}
                            style={index.iconExtend}
                        />
                        <Image
                            source={require('../../assets/images/ChatSingle/IconMic.png')}
                            style={index.iconMic}
                        />
                    </View>
                </View>
            ...
            <View style={index.Header}>
                ...
                >
                    <View style={index.BoxTop}>
                        ...
                        <View style={index.BoxAdd}>
                            <Image
                                source={require('../../assets/images/ChatSingle/Call.png')}
                                style={index.IconCall}
                            />
                            <Image
                                source={require('../../assets/images/ChatSingle/VideoCall.png')}
                                style={index.VideoCall}
                            />
                            <Image
                                source={require('../../assets/images/ChatSingle/Seting.png')}
                                style={index.Seting}
                            />
                        </View>
                    </View>
    ...
    const Silent = (item) => {
        if (item.silent == true) {
            return (
                <Image
                    source={require('../../assets/images/ChatSingle/Silent.png')}
