...
const VideoScreenConnect = ({ navigation }) => {
    const [changeVolum, setChangeVolum] = useState(true)
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <View style={styles.bodyContainer}>
                    ...
                    <Text style={styles.textBody}>00.00</Text>
...
export default VideoScreenConnect
