...
const ScreenPhoneInput = ({ navigation }) => {
    ...
    return (
        <View style={styles.containerCreate}>
            <TouchableOpacity
                onPress={() => {
                    navigation.navigate('ScreenWait')
                }}
            >
                <FontAwesome5
                    name='arrow-left'
            ...
            {/* <View style={styles.titleLogin}>
                <View>
                    ...
                    >
                        <Image
                            source={require('../SChat/assets/images/Vector.png')}
                        ></Image>
                    </Text>
                </View>
                <Text style={styles.titleCreate}>Đăng ký</Text>
                <Text style={styles.textTitle}>
                    Bạn đã có tài khoản SChat chưa?
                    <Text
            ...
            <View style={styles.boxSurname}>
                <Text style={styles.textLoginName}>Nhập số điện thoại</Text>
            ...
            <View style={styles.boxNext}>
                <TouchableOpacity
                    ...
                    onPress={(MessageEro) => {
                        //navigation.navigate("ChildCreateOTP");
                        if (Number == '') {
                            ...
                            if (
                                ...
                                if (Number.length != 9) {
                                    //alert("Chưa đủ 9 chữ số, không bao gồm chữ số 0 ở đầu")
                                    setPhoneNumberError(
                                        'Vui lòng nhập đúng 9 chữ số, không bao gồm chữ số 0 ở đầu'
                                    )
                                } else navigation.navigate('ChildCreateOTP')
                            }
                        }
                    }}
                >
