                        ...
                        if (Number == '') {
                            ...
                            if (
                                ...
                                if (Number.length != 9) {
                                    ...
                                    await axios
                                        .post(
                                            'http://172.21.20.58:3000/auth/login',
                                            {
...
=======
      <View style={SigninScreenTheme.boxSurname}>
        ...
        <View style={SigninScreenTheme.PhoneInput}>
          ...
          />
>>>>>>> ccea113d878075670400dffcc51da4d0fa1fb265
        </View>
      </View>
      ...
      <View style={SigninScreenTheme.boxNext}>
              ...
              if (Number.includes(".") == true || isFinite(Number) == false) {
                ...
                if (Number.length != 9) {
                  ...
                  const responseFromSmsRequirement = await fetch(
                    "http://0c88-14-226-236-187.ngrok.io/auth/login",
                    {
                      method: "POST",
                      headers: {
                        "Content-Type":
        ...
        >
          <Text style={SigninScreenTheme.appButtonTextCreate}>Đăng nhập</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
