        ...
        <View style={SigninScreen.container}>
            ...
            >
                <FontAwesome5
                    name='arrow-left'
                    size={20}
                    style={SigninScreen.arrowLeftIcon}
                />
            </TouchableOpacity>

            <SignupScreenComponent />

            <View style={SigninScreen.boxSurname}>
                <Text style={SigninScreen.textLoginName}>Số điện thoại của bạn</Text>
                <View style={SigninScreen.PhoneInput}>
                    <PhoneInput
            ...
            <View style={SigninScreen.PhoneMessageError}>
                {PhoneNumberError.length > 0 && (
                    <Text style={SigninScreen.textPhoneError}>
                        {PhoneNumberError}
                    </Text>
                )}
            </View>

            <View style={SigninScreen.boxNext}>
                <TouchableOpacity
                    style={SigninScreen.ButtonLoginNext}
                ...
                >
                    <Text style={SigninScreen.appButtonTextCreate}>Đăng nhập</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
...
const SigninScreen = SigninScreenheet.create({
    container: {
