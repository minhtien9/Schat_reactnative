        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={NewJobBodyTheme.container}>
            ...
            <View style={NewJobBodyTheme.TienDo}>
              <Text style={NewJobBodyTheme.txtTiendo}>Tiến độ:</Text>
              <TextInput
            ...
            {/* Nhom cong viec */}
            <Text style={NewJobBodyTheme.txtGroupWork}>Nhóm công việc</Text>
            <SelectDropdown
              data={GroupWork}
              onSelect={(selectedItem, index) => {
                console.log(selectedItem, index);
            ...
            <TouchableOpacity style={NewJobBodyTheme.File}>
              <Text style={NewJobBodyTheme.txtFile}>Tải file đính kèm</Text>
            </TouchableOpacity>

            {/* Giao cho ai */}
            <Text style={NewJobBodyTheme.txtGiaoChoAi}>Giao cho ai</Text>
            <View>
              <Modal
                animationType={"slide"}
                transparent={true}
              ...
              >
                ...
                <View style={NewJobBodyTheme.modal}>
                  <View style={{ width: 350, marginTop: -95 }}>
                    <KeyboardAvoidingView onFocus={() => setenableShift(false)}>
                      <SelectBox
                        listOptionProps={{ maxHeight: 235 }}
                        label={false}
                        options={NAME}
                        ...
                        optionsLabelStyle={{ fontSize: 14 }} // style ten trong muc chon
                        inputFilterStyle={{ fontSize: 12 }} // style chon trong muc tim ten
                        width="100%"
                      />
                    </KeyboardAvoidingView>
                  </View>
                  ...
                  >
                    <Text style={{ fontSize: 12, color: "#353535" }}>Đóng</Text>
                  </TouchableOpacity>
                </View>
              </Modal>
              <TouchableOpacity
            ...
            {/* Thoi han */}
            <Text style={NewJobBodyTheme.txtDuration}>Thời hạn</Text>
            <TouchableOpacity
              onPress={showDatePicker}
              style={NewJobBodyTheme.btnDurationBar}
            >
              <Text style={NewJobBodyTheme.txtInputDuration}>{data}</Text>
              <DateTimePickerModal
            ...
            <View
              style={{ flexDirection: "row", marginTop: 16, marginLeft: 153 }}
            >
              <TouchableOpacity style={NewJobBodyTheme.Cancel}>
                <Text style={NewJobBodyTheme.btnCancel}>HỦY</Text>
              </TouchableOpacity>
              <TouchableOpacity style={NewJobBodyTheme.Assign}>
                <Text style={NewJobBodyTheme.btnAssign}>GIAO VIỆC</Text>
              </TouchableOpacity>
            </View>
          </View>
        </TouchableWithoutFeedback>
