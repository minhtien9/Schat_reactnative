              ...
              <View style={styles.innerTop}>
                <View style={styles.innerTopLeft}>
                  <Checkbox
                    ...
                    color={isChecked ? "#27AAE1" : undefined}
                  />

                  <Text style={styles.innerTopTxt}>Thiết kế CSDL Ver.1</Text>
                </View>
              ...
              <View style={styles.innerBottom}>
                <View style={styles.imgContainer}>
                  <Image
                    ...
                    resizeMode="stretch"
                  />
                  <AntDesign name="right" size={10} color="#919191" />
                  <Image
          ...
          <View style={styles.item}>
            <View style={{ marginTop: 16 }}>
              ...
              <View style={styles.innerBottom}>
                ...
                <Text style={{ color: "red", fontSize: 9 }}>10%</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
