...
import { SetAccessToken } from '../../store/actions/auth.action'
...
const InputOTPSigninScreenComponent = ({ route, navigation }) => {
    ...
    async function requireSms() {
        ...
        const responseFromSmsVerification = await fetch(
            'http://0c88-14-226-236-187.ngrok.io/auth/sms-verification',
            {
                method: 'POST',
                headers: {
                    'Content-Type':
