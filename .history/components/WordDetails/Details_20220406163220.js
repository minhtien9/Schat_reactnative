...
const dataField = [
    { label: 'Lập trình viên', value: '1' },
    { label: 'Hành chính', value: '2' },
    { label: 'Chính trị', value: '3' },
    { label: 'Quân sự', value: '4' },
]

const dataNameGroup = [
    { label: 'Nhóm Design', value: '1' },
    { label: 'Nhóm Dev', value: '2' },
    { label: 'Nhóm BA', value: '3' },
    { label: 'Nhóm IT', value: '4' },
]
...
const Details = () => {
    ...
    const [workingGroup, setWorkingGroup] = useState('Nhóm thiết kế CSDL')
    ...
    return (
        <ScrollView style={styles.screen}>
            ...
            <View style={styles.container}>
                ...
                >
                    Lập trình viên Hành chính', Chính trị', Quân sự',
                    <Picker.Item
