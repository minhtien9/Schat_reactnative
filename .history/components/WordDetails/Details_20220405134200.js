...
const Details = () => {
    ...
    const [nameGroup, setNameGroup] = useState(' Nhóm thiết kế CSDL')
    ...
    return (
        <ScrollView style={styles.screen}>
            ...
            <View style={styles.container}>
                ...
                <TextInput style={styles.textContent}>{field}</TextInput>
            </View>
            <View style={styles.container}>
                <Text style={styles.textProgress}>Nhóm công việc</Text>
                <TextInput style={styles.textDesign}>{workingGroup}</TextInput>
            </View>
            <View style={styles.container}>
